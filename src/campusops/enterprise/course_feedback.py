...
class CourseFeedbackRule:
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> "CourseFeedbackRule":
        return cls(
...
class CourseFeedbackAction:
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> "CourseFeedbackAction":
        return cls(
...
class CourseFeedbackCase:
    ...
    actions: tuple[CourseFeedbackAction, ...] = field(default_factory=tuple)
    tags: tuple[str, ...] = field(default_factory=tuple)
    ...
    def with_status(self, status: object, *, actor: object, message: object = "") -> "CourseFeedbackCase":
    ...
    def with_owner(self, owner: object, *, actor: object) -> "CourseFeedbackCase":
    ...
    def with_rule_matches(self, rules: Iterable[CourseFeedbackRule]) -> "CourseFeedbackCase":
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> "CourseFeedbackCase":
        return cls(
            ...
            actions=tuple(CourseFeedbackAction.from_dict(row) for row in payload.get("actions", ())),
            tags=tuple(payload.get("tags") or ()),
        )


class CourseFeedbackEngine:
    def __init__(
        self,
        cases: Iterable[CourseFeedbackCase] | None = None,
        rules: Iterable[CourseFeedbackRule] | None = None,
    ) -> None:
        self._cases: dict[str, CourseFeedbackCase] = {}
        self._rules: dict[str, CourseFeedbackRule] = {}
    ...
    def add_rule(self, rule: CourseFeedbackRule) -> CourseFeedbackRule:
        if rule.rule_id in self._rules:
            raise ValueError(f"rule already exists: {rule.rule_id}")
        self._rules[rule.rule_id] = rule
        return rule

    def add_case(self, case: CourseFeedbackCase, *, evaluate: bool = True) -> CourseFeedbackCase:
    ...
    def get_case(self, case_id: object) -> CourseFeedbackCase:
    ...
    def update_status(self, case_id: object, status: object, *, actor: object, message: object = "") -> CourseFeedbackCase:
        case = self.get_case(case_id).with_status(status, actor=actor, message=message)
        self._cases[case.case_id] = case
        return case

    def assign_owner(self, case_id: object, owner: object, *, actor: object) -> CourseFeedbackCase:
        case = self.get_case(case_id).with_owner(owner, actor=actor)
        self._cases[case.case_id] = case
        return case

    def reevaluate(self, case_id: object | None = None) -> list[CourseFeedbackCase]:
        selected = [self.get_case(case_id)] if case_id is not None else list(self._cases.values())
        updated: list[CourseFeedbackCase] = []
    ...
    def cases_by_status(self, status: object) -> list[CourseFeedbackCase]:
    ...
    def cases_by_owner(self, owner: object) -> list[CourseFeedbackCase]:
    ...
    def open_cases(self) -> list[CourseFeedbackCase]:
    ...
    def closed_cases(self) -> list[CourseFeedbackCase]:
    ...
    def snapshot(self) -> dict[str, Any]:
        return {
            "domain": "course_feedback",
            "case_type": "feedback_case",
    ...
    @classmethod
    def load_json(cls, path: str | Path) -> "CourseFeedbackEngine":
        payload = json.loads(Path(path).read_text(encoding="utf-8"))
        rules = [CourseFeedbackRule.from_dict(row) for row in payload.get("rules", ())]
        cases = [CourseFeedbackCase.from_dict(row) for row in payload.get("cases", ())]
